...
<figure className="beaconFigure">
  ...
  <figcaption>Valid worksheets become deterministic BFF JSON collections.</figcaption>
</figure>
...
<figure className="beaconFigure">
  ...
  <figcaption>Conversion writes compressed BFF genomic variations plus a reproducibility log.</figcaption>
</figure>
...
Generate the standalone **BFF GenomicVariations Browser** during conversion:
...
Open the generated HTML file directly. It includes searching, sorting, column controls, pagination for large tables, gene panels, and assembly-aware links to external variant databases.
