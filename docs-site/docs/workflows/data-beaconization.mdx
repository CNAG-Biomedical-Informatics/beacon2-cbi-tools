...
The [CINECA synthetic workbook](https://github.com/CNAG-Biomedical-Informatics/beacon2-cbi-tools/blob/main/CINECA_synthetic_cohort_EUROPE_UK1/Beacon-v2-Models_CINECA_UK1.xlsx) is a populated reference.
...
:::info[CINECA chr22 conversion benchmark]
On a 6-core ARM64 Linux workstation, the single-process converter processed an already fully annotated CINECA chr22 VCF with 2,504 samples and 1,110,240 input records in **1 minute 47 seconds**, producing 1,109,368 BFF records with about **20 MB peak RAM**. This measures only VCF-to-BFF conversion; SnpEff/SnpSift annotation and standalone report generation are separate stages. CPU and storage performance will affect runtime.
:::
