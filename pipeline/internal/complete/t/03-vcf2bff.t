...
# Define file names
my $output_file    = "t/genomicVariationsVcf.json.gz";
my $reference_file = "t/expected_genomicVariationsVcf.json.gz";    # adjust if needed
...
my $cmd =
"perl vcf2bff.pl -i t/test_pathogenic.vcf.gz --genome hg19 -dataset-id foo -project-dir 123456789 -f bff -out-dir t";
