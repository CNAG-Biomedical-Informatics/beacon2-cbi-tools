...
#
#   NOTE:
#     - We KEEP the default DataTables info line + pagination BELOW the table.
#     - Therefore, we REMOVED the extra "counter" above each table.
#
...
Adds:
  ...
  - Keeps DataTables built-in info + pagination below the table
